...
// Inheritance is a mechanism where one class (child) can inherit the properties and 
// methods of another class (parent).
// Inheritance allows you to reuse the functionality of an existing class without 
// rewriting it.

// Method Overriding:
// A subclass/child calss can provide a specific implementation of a method that is 
...
//car.yom();   // Not accessible yom() defeind inside the child class but not in the parent 
// parent